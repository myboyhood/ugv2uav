...
int main(int argc, char** argv) {
    ros::init(argc, argv, "designed_waypoint_publisher");
    ros::NodeHandle nh;

    ROS_INFO("Started designed_waypoint_publisher.");
//    ros::Rate rate(0.5);
//    ros::V_string args;
...
//        return -1;
//    }
	//! Edit here to generate your trajectory
    std::vector<WaypointWithTime> waypoints;
    const float DEG_2_RAD = M_PI / 180.0;
    double t=1, x=2, y=0, z=1, yaw=0;
    for (int j = 0; j < 1; ++j) {
        x=2.5;y=-1;z=1;yaw=0;
...
//    }//(2,0)->(22,0)
//    for (int j = 0; j < 30; ++j) {
//        x=22;y-=0.5;z=1;yaw=0;
//        waypoints.push_back(WaypointWithTime(t, x, y, z, yaw * DEG_2_RAD));
//    }//(22,0)->(22,-15)
//    for (int j = 0; j < 20; ++j) {
//        x+=0.5;y=-15;z=1;yaw=0;
//        waypoints.push_back(WaypointWithTime(t, x, y, z, yaw * DEG_2_RAD));
//    }//(22,-15)->(32,-15)
//    for (int j = 0; j < 10; ++j) {
//        x=2;y+=0.05;z=1;yaw=0;
//        waypoints.push_back(WaypointWithTime(t, x, y, z, yaw * DEG_2_RAD));
//    }
//    for (int j = 0; j < 10; ++j) {
//        x=2.5;y-=0.1;z=1;yaw-=5;
//        waypoints.push_back(WaypointWithTime(t, x, y, z, yaw * DEG_2_RAD));
//    }
//    for (int j = 0; j < 5; ++j) {
//        x=0;y+=0.0;z=0.5;
...
//    }
    ...
    ROS_INFO("Start publishing designed_waypoints.");
    std::cout << "waypoint size is " << waypoints.size() << std::endl;
